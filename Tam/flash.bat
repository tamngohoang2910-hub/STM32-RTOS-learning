...
:: --- BỔ SUNG: Tự động chuyển về đúng ổ D và thư mục Task3 ---
D:
cd /d D:\RTOS STM32\Tam
...
STM32_Programmer_CLI -c port=SWD sn=37FF71064E57343687001143 -w build/Tam.elf 0x08000000 -v -rst
